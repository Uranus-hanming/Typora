...
- 如图:
    - [外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-WHBQlgGB-1677597379248)(images/urls.png)]
#### include 函数
- 作用:
...
- ORM 示意
    - [外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-cLrq3lgw-1677597379250)(images/orm.png)]
...
- 启动方式:
    ...
    $ obj = Author.objects.create(name='王老师',age=28,email='wangweichao@tedu.cn')
    ```
