...
- MVC 设计模式
    ...
    - MVC模式如图:
        [外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-Ui77Cq27-1677597330226)(images/mvc.png)]
- MTV 模式
    ...
    - MTV模式如图:
        [外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-AWGGKN31-1677597330228)(images/mtv.png)]
...
- 模板的继承示例:
    ...
    - [外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-CmcpkT0S-1677597330230)(images/template_inherit.png)]
